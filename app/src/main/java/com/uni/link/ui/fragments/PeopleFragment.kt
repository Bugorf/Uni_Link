...
import com.uni.link.ui.viewmodels.DeletedUserViewHolder
import com.uni.link.ui.viewmodels.UsersViewHolder
...
/**
 *  Afficher tous les utilisateur déjà inscrits dans une liste
 **/
    ...
    private fun setUpAdapter() {
        ...
        mAdapter = object : FirestorePagingAdapter<User, RecyclerView.ViewHolder>(options) {
            ...
            override fun getItemViewType(position: Int): Int {
                ...
                return if (auth.uid == item!!.userId) {
                    DELETED_VIEW_TYPE
                } else {
                    NORMAL_VIEW_TYPE
                }
